...
options_ = [];
M_.fname = 'Simple_Neoclassical_Growth_Model';
...
M_.endo_names(3) = {'AUX_EXO_LEAD_18'};
M_.endo_names_tex(3) = {'AUX\_EXO\_LEAD\_18'};
M_.endo_names_long(3) = {'AUX_EXO_LEAD_18'};
...
save([M_.dname filesep 'Output' filesep 'Simple_Neoclassical_Growth_Model_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Simple_Neoclassical_Growth_Model_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Simple_Neoclassical_Growth_Model_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Simple_Neoclassical_Growth_Model_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Simple_Neoclassical_Growth_Model_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Simple_Neoclassical_Growth_Model_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Simple_Neoclassical_Growth_Model_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
