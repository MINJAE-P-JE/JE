...
varexo SHK_L_GDP_GAP SHK_DLA_CPI SHK_L_S SHK_RS SHK_RR_BAR SHK_DLA_Z_BAR SHK_DLA_GDP_BAR SHK_D4L_CPI_TAR;
varexo SHK_L_GDP_RW_GAP SHK_RS_RW SHK_DLA_CPI_RW SHK_RR_RW_BAR;
